...
const els = {
  // authStatus, loginBtn 제거됨 (2026-04-21)
...
async function apiJson(path, options = {}, _requireAuth = false, allow404 = false) {
...
async function claimDemoAccess() {
  ...
  if (!team) return;
  try {
    // auth 제거 (2026-04-21). 기본 pilot 값으로 대체.
    const emailPrefix = 'pilot';
    const fullName = '파일럿 관리자';
