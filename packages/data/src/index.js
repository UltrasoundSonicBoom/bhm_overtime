...
export const DATA_STATIC = {
  ...
  allowances: {
    ...
    overtimeRates: {
      ...
      night: 2.0,          // 야간근무 200% (22:00~06:00, 제47조)
      extendedNight: 2.0,  // 통상근무자 연장→야간 200%
      holiday: 1.5,        // 휴일근무 150% (8시간 이내)
      holidayOver8: 2.0,   // 휴일근무 200% (8시간 초과, 제34조)
  ...
  leaveQuotas: {
    ...
    types: [
      ...
      },
      {
        ...
        ceremonyDays: 20, ceremonyPay: 100000, docs: '주민등록등본(가족관계증명서)', extra: '출산일로부터 120일 이내 사용 완료, 3회 분할 가능'
      },
      {
  ...
  faq: [
    ...
    { category: '온콜', q: '온콜 출근하면 수당이 얼마인가요?', a: '출근 시 2가지 수당 지급:\n• ① 온콜교통비: 50,000원/회\n• ② 시간외근무수당: 실근무시간 + 출퇴근 2시간 인정\n\n※ 온콜 출근 시 대기수당은 중복 지급 안 됨', ref: '제32조 (9)항, 별도합의' },
    { category: '온콜', q: '온콜 출퇴근 시간 인정은?', a: '온콜 출근 시 출퇴근 2시간이 근무시간으로 인정\n\n예시: 23:00 호출\n• 실근무 23:00~03:00 (4시간)\n• 출퇴근 인정 (+2시간)\n• 총 인정시간: 6시간', ref: '제32조 (9)항' },

    // ── 야간근무 ──
    { category: '야간근무', q: '야간근무 기준은?', a: '• 월 7일 기준\n• 9일 초과 금지\n• 10일 이상 시 → 시간외수당으로 처리', ref: '별도합의 (교대근로자 야간근무)' },
    { category: '야간근무', q: '야간근무가산금이란?', a: '3교대 근무자 대상\n• 야간근무 1회당 10,000원\n• 야간근무수당과 별도 지급', ref: '별도합의 (2015.05)' },
    { category: '야간근무', q: '리커버리데이란?', a: '3교대 간호본부 대상\n• 7일 이상 야간근무 시 → 1일 부여\n• 누적 15일당 7일에 1일 추가 부여\n• 미사용분은 시간외수당 대체 가능 (2023.01~)', ref: '제32조, 별도합의' },
    { category: '야간근무', q: '40세 이상이면 야간근무 안 해도 되나요?', a: '원칙적으로 배치하지 않음\n• 대상: 40세 이상 간호부 교대근무자\n• 단, 본인이 희망하면 가능', ref: '제32조 (8)항' },
    ...
    { category: '휴가', q: '교육연수 휴가는?', a: '• 교육연수: 연 3일\n• 병원필수교육: 연 3일 (하반기)\n• 보수교육(방사선학회): 1일\n• 외부교육(방사선작업종사자): 1일', ref: '복무규정' },
    { category: '휴가', q: '가족돌봄 휴가는?', a: '• 유급: 2일 (다자녀/장애 자녀 3일)\n• 무급: 10일', ref: '제37조, 단체협약' },
    { category: '휴가', q: '예비군/민방위 휴가는?', a: '훈련일수만큼 유급 휴가 부여', ref: '복무규정' },
    { category: '휴가', q: '장기재직 휴가는?', a: '• 10년 재직: 5일\n• 20년 이상: 7일', ref: '2025.10단협' },

    // ── 경조 (청원휴가) ──
    { category: '경조', q: '결혼하면 휴가와 지원금은?', a: '본인 결혼:\n• 휴가 5일 + 경조비 300,000원 + 축하화환\n\n자녀 결혼:\n• 휴가 1일 + 경조비 100,000원\n• 청첩장·등본 제출', ref: '제63조' },
    { category: '경조', q: '부모님 돌아가시면 휴가와 지원금은?', a: '본인·배우자 부모 사망:\n• 휴가 5일 + 경조비 300,000원\n• 사학연금 가입자는 사망조위금 별도 지급', ref: '제63조' },
    { category: '경조', q: '배우자 돌아가시면?', a: '배우자 사망:\n• 휴가 5일 + 경조비 1,000,000원\n• 사학연금 가입자는 사망조위금 별도 지급', ref: '제63조' },
    { category: '경조', q: '자녀가 돌아가시면?', a: '자녀 사망:\n• 휴가 3일 + 경조비 300,000원\n\n※ 자녀 배우자 사망 시 경조금 없음', ref: '제63조' },
    { category: '경조', q: '할머니 할아버지 돌아가시면?', a: '조부모·외조부모 사망:\n• 휴가 3일 + 경조비 50,000원', ref: '제63조' },
    { category: '경조', q: '외할머니 외할아버지 돌아가시면?', a: '외조부모 사망:\n• 휴가 3일 + 경조비 50,000원', ref: '제63조' },
    { category: '경조', q: '형제자매가 돌아가시면?', a: '형제·자매 사망:\n• 휴가 3일 + 경조비 50,000원', ref: '제63조' },
    { category: '경조', q: '출산하면 경조비는?', a: '병원 지급:\n• 경조비 100,000원 + 출산휴가 90일\n\n조합 지원:\n• 첫째·둘째: 100,000원\n• 셋째 이상: 300,000원', ref: '제63조, 제38조' },
    { category: '경조', q: '입양하면 휴가는?', a: '• 휴가 20일\n• 입양증명서 제출 필요', ref: '제63조' },
    { category: '경조', q: '경조비 지급 기준은?', a: '결혼:\n• 본인 300,000원 / 자녀 100,000원\n\n출산:\n• 100,000원\n\n사망:\n• 배우자 1,000,000원\n• 부모 300,000원\n• 자녀 300,000원\n• 조부모·외조부모·형제자매 각 50,000원', ref: '제63조' },
    { category: '경조', q: '경조휴가 구비서류는?', a: '• 결혼: 청첩장·등본\n• 출산: 등본·출생증명서\n• 사망: 사망진단서\n• 입양: 입양증명서\n\n※ 본인 결혼은 서류 불필요', ref: '제63조' },

    // ── 임금/수당 ──
    { category: '수당', q: '급여일이 언제인가요?', a: '• 일반직·환경유지지원직: 당월 17일\n• 의사직: 25일\n• 단시간직: 익월 5일', ref: '제48조' },
    { category: '수당', q: '가계지원비 지급 월은?', a: '지급월 (총 11개월):\n• 3, 4, 5, 6, 7, 8, 10, 11, 12월\n• + 설·추석이 있는 달\n\n미지급월: 1월, 9월', ref: '별표' },
    { category: '수당', q: '명절지원비는 언제?', a: '연 4회 지급:\n• 설이 속하는 달\n• 추석이 속하는 달\n• 5월\n• 7월\n\n금액 = (기본급 + 조정급의 1/2) × 50%', ref: '별표' },
    { category: '수당', q: '가족수당은 얼마인가요?', a: '• 배우자: 40,000원\n• 첫째 자녀: 30,000원\n• 둘째 자녀: 70,000원\n• 셋째 이상: 110,000원\n• 기타 가족: 20,000원 (5인 이내)', ref: '제49조' },
    { category: '수당', q: '장기근속수당은?', a: '• 5~10년: 50,000원\n• 10~15년: 60,000원\n• 15~20년: 80,000원\n• 20~21년: 100,000원\n• 21년+: 1년당 10,000원 가산\n• 25년+: 1년당 30,000원 가산', ref: '제50조' },
    { category: '수당', q: '교통보조비·급식보조비는?', a: '• 교통보조비: 월 150,000원\n• 급식보조비: 월 150,000원', ref: '별표' },
    { category: '수당', q: '리프레시지원비란?', a: '• 월 30,000원 (연 360,000원)\n• 2026.01.01부터 통상임금 산입\n\n사용 가능 범위:\n• 건강관리: 스포츠센터, 체력단련\n• 능력계발: 도서, 학원, 온라인강의\n• 문화생활: 공연, 전시, 영화, 시험 응시료', ref: '별도합의 (2024.11)' },
    { category: '수당', q: '통상임금이 뭐에요?', a: '소정근로에 정기적·일률적·고정적으로 지급하는 임금\n\n• 시급 = 통상임금 ÷ 209시간\n\n구성 항목 (19개):\n기본급, 능력급, 상여금, 조정급, 급식보조비, 교통보조비, 리프레시지원비, 연구보조비, 위험수당, 분석수당, 직책수당, 관리수당, 군복무수당, 장기근속수당, 자격증수당, 면허수당, 근속가산기본급, 보전수당, 가족수당', ref: '제46조' },
    ...
    { category: '휴가', q: '미사용 연차 보상금은?', a: '잔여 연차 × 통상임금 일액 (시급 × 8시간)\n\n• 시급 = 통상임금 월액 ÷ 209시간\n• 계산기: CALC.calcAnnualLeaveBonus(unusedDays, monthlyWage)\n• 예: 미사용 3일 · 월급 3,135,000원 → 360,000원\n• 프로필 입력 시 자동 계산', ref: '제36조(4) · 보수규정' },

    // ── 휴직 ──
    { category: '휴직', q: '육아휴직 급여는?', a: '• 1~3개월: 통상임금 100% (상한 2,500,000원)\n• 4~6개월: 통상임금 100% (상한 2,000,000원)\n• 7~12개월: 통상임금 80% (상한 1,600,000원)\n\n3회 분할 가능, 이후 연 단위 사용 가능', ref: '제37조 제2항 3호' },
    { category: '휴직', q: '자기계발 휴직 자격은?', a: '• 재직 5년 이상 (2022년~)\n• 1년 이내 사용 (6개월 단위)\n• 10년 이상 재직자: 6개월 추가 가능', ref: '제37조' },
    { category: '휴직', q: '질병휴직 급여는?', a: '(기준기본급 + 능력급 + 상여금 + 조정급) × 70%', ref: '제37조' },

    // ── 승진 ──
    { category: '승진', q: '자동승격 연수는?', a: '일반직:\n• J1→J2: 4년\n• J2→J3: 7년\n• J3→S1: 8년\n\n운영기능직:\n• A1→A2: 4년\n• A2→A3: 7년\n• A3→C1: 7년', ref: '보수표' },
    { category: '승진', q: '2026년부터 승진연수가 바뀌나요?', a: '2026.01.01 입사자부터 새 연수 적용:\n\n일반직:\n• J1·J2·J3 = 4년·7년·8년\n\n운영기능직/환경유지지원직:\n• 4년·7년·7년\n\n※ 2025.12.31 이전 입사자는 기존 유지', ref: '별도합의 (2025.10)' },
    { category: '승진', q: '퇴직금은 어떻게 계산하나요?', a: '퇴직금 = 월 평균임금 × 계속근로년수\n\n• 정년: 만 60세, 정년퇴직일은 해당 연도 12월 말일\n• 1년 이상 근속자 대상\n• 1년 미만 단수: 6개월 이상은 1년, 6개월 미만은 월할\n• 2001.08.31 이전 근속분은 누진배수 적용\n• 2015.06.30 현재 재직자는 퇴직수당 별도\n• 만60세 이후 퇴직자는 만60세 직전 평균임금 기준\n• 따라서 공로연수 1년을 선택해도 퇴직금 기준 평균임금은 공로연수 전 3개월 기준으로 보호됨\n• 정년 전 1년은 공로연수 1년(보수 60%) 또는 계속근무(직전년도 보수 100%) 선택', ref: '제24조, 제40조, 제52조(4), 제53조(2), <2022.12>' },
