...
- [ ] **Step 3: career-events.js 수정 — calcOrdinaryWage 호출로 항목별 차액 산출**
...
- [ ] **Step 1: detailTokens 렌더 로직을 `_careerBuildEventEl` 에 추가**
...
- [ ] **Step 2: globals.css 에 detail-grid + 다음 승급 카드 스타일 추가**
...
- [ ] **Step 3: `_careerHeroStat` 끝에 다음 승급 카드 삽입**
...
- [ ] **Step 3: career-events.js 에 동적 leave helper export**
...
- [ ] **Step 4: profile-tab.js — renderCareerTimeline 가 dynamic 합치도록 수정**
...
- [ ] **Step 2: career-events-sync.js 생성**
...
- [ ] **Step 3: career-events.js saveEvents 에 write-through hook**
...
- [ ] **Step 4: hydrate.js 에 careerEvents 추가** (Firestore → localStorage)
...
- [ ] **Step 1: migration-dialog.js 의 카테고리 정의에 추가**
...
- [ ] **Step 2: captureGuestMigrationSnapshot 에도 포함되는지 확인**
